namespace Collection_of_Persons.Tests
{
    ...
    public class UnitTestsPersonCollection
    {
        ...
        public void FindPersonsByEmailDomain_ShouldReturnMatchingPersons()
        {
            ...
            // Act
            var personsGmail = this.persons.FindPeople("gmail.com");
            var personsYahoo = this.persons.FindPeople("yahoo.co.uk");
            var personsHoo = this.persons.FindPeople("hoo.co.uk");
        ...
        public void FindPersonsByNameAndTown_ShouldReturnMatchingPersons()
        {
            ...
            // Act
            var personsPeshoPlovdiv = this.persons.FindPeople("Pesho", "Plovdiv");
            var personsLowercase = this.persons.FindPeople("pesho", "plovdiv");
            var personsPeshoNoTown = this.persons.FindPeople("Pesho", null);
            var personsAnnaBourgas = this.persons.FindPeople("Anna", "Bourgas");
        ...
        public void FindPersonsByAgeRange_ShouldReturnMatchingPersons()
        {
            ...
            // Act
            var personsAgedFrom21to22 = this.persons.FindPeople(21, 22);
            var personsAgedFrom10to11 = this.persons.FindPeople(10, 11);
            var personsAged21 = this.persons.FindPeople(21, 21);
            var personsAged19 = this.persons.FindPeople(19, 19);
            var personsAgedFrom0to1000 = this.persons.FindPeople(0, 1000);
        ...
        public void FindPersonsByAgeRangeAndTown_ShouldReturnMatchingPersons()
        {
            ...
            // Act
            var personsAgedFrom21to22Plovdiv = this.persons.FindPeople(21, 22, "Plovdiv");
            var personsAgedFrom10to11Sofia = this.persons.FindPeople(10, 11, "Sofia");
            var personsAged21Plovdiv = this.persons.FindPeople(21, 21, "Plovdiv");
            var personsAged19Bourgas = this.persons.FindPeople(19, 19, "Bourgas");
            var personsAgedFrom0to1000Plovdiv = this.persons.FindPeople(0, 1000, "Plovdiv");
            var personsAgedFrom0to1000NewYork = this.persons.FindPeople(0, 1000, "New York");
        ...
        public void MultipleOperations_ShouldReturnWorkCorrectly()
        {
            ...
            var personsPeshoSofia = this.persons.FindPeople("Pesho", "Sofia");
            Assert.AreEqual(0, personsPeshoSofia.Count());

            var personsKiroPlovdiv = this.persons.FindPeople("Kiro", "Plovdiv");
            Assert.AreEqual(0, personsKiroPlovdiv.Count());

            var personsAge22To28 = this.persons.FindPeople(22, 28);
            CollectionAssert.AreEqual(
                new string[] { "asen@gmail.com", "kiro@yahoo.co.uk", "pesho@gmail.com" },
                personsAge22To28.Select(p => p.Email).ToList());

            var personsAge22To28Plovdiv = this.persons.FindPeople(22, 28, "Plovdiv");
            CollectionAssert.AreEqual(
            ...
            personsGmail = this.persons.FindPeople("gmail.com");
            CollectionAssert.AreEqual(
                new string[] { "asen@gmail.com" },
                personsGmail.Select(p => p.Email).ToList());

            personsPeshoPlovdiv = this.persons.FindPeople("Pesho", "Plovdiv");
            CollectionAssert.AreEqual(
                new string[] { },
                personsPeshoPlovdiv.Select(p => p.Email).ToList());

            personsPeshoSofia = this.persons.FindPeople("Pesho", "Sofia");
            Assert.AreEqual(0, personsPeshoSofia.Count());

            personsKiroPlovdiv = this.persons.FindPeople("Kiro", "Plovdiv");
            Assert.AreEqual(0, personsKiroPlovdiv.Count());

            personsAge22To28 = this.persons.FindPeople(22, 28);
            CollectionAssert.AreEqual(
                new string[] { "asen@gmail.com", "kiro@yahoo.co.uk" },
                personsAge22To28.Select(p => p.Email).ToList());

            personsAge22To28Plovdiv = this.persons.FindPeople(22, 28, "Plovdiv");
            CollectionAssert.AreEqual(
                new string[] { "kiro@yahoo.co.uk" },
                personsAge22To28Plovdiv.Select(p => p.Email).ToList());
        }
