namespace Collection_of_Persons.Tests
{
    ...
    public class PerformanceTestsPersonCollection
    {
        ...
        public void TestPerformance_FindPersonsByEmailDomain()
        {
            ...
            {
                var existingPersons = 
                    this.persons.FindPeople("gmail1.com").ToList();
                Assert.AreEqual(50, existingPersons.Count);
                var notExistingPersons = 
                    this.persons.FindPeople("non-existing email").ToList();
        ...
        public void TestPerformance_FindPersonsByNameAndTown()
        {
            ...
            {
                var existingPersons = 
                    this.persons.FindPeople("Pesho1", "Sofia1").ToList();
                Assert.AreEqual(50, existingPersons.Count);
                var notExistingPersons =
                    this.persons.FindPeople("Pesho1", "Sofia5").ToList();
                Assert.AreEqual(0, notExistingPersons.Count);
            }
        }
        ...
        public void TestPerformance_FindPersonsByAgeRange()
        {
            ...
            {
                var existingPersons =
                    this.persons.FindPeople(20, 21).ToList();
                Assert.AreEqual(100, existingPersons.Count);
                var notExistingPersons =
                    this.persons.FindPeople(500, 600).ToList();
                Assert.AreEqual(0, notExistingPersons.Count);
            }
        }
        ...
        public void TestPerformance_FindPersonsByTownAndAgeRange()
        {
            ...
            {
                var existingPersons =
                    this.persons.FindPeople(18, 22, "Sofia20").ToList();
                Assert.AreEqual(50, existingPersons.Count);
                var notExistingTownPersons =
                    this.persons.FindPeople(20, 30, "Missing town").ToList();
                Assert.AreEqual(0, notExistingTownPersons.Count);
                var notExistingAgePersons =
                    this.persons.FindPeople(200, 300, "Sofia1").ToList();
                Assert.AreEqual(0, notExistingTownPersons.Count);
            }
        }
    }
