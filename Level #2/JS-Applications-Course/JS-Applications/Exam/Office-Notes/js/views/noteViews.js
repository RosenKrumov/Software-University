...
app.noteViews = (function() {
    ...
    function loadNotesView (condition, selector, data) {
        if(condition === "My notes") {
            return $.get('templates/myNoteTemplate.html', function (template) {
                ...
                $('.edit').click(function() {
                    ...
                    var deadline = $(this).parent().find('.deadline').text();
                    window.location.replace('#/editNote/id='+id+'&title='+title+'&text='+text+'&deadline='+deadline);
                });
                $('.delete').click(function() {
                    ...
                    var text = $(this).parent().find('#text').text();
                    var deadline = $(this).parent().find('.deadline').text();
                    window.location.replace('#/deleteNote/id='+id+'&title='+title+'&text='+text+'&deadline='+deadline);
                });
            });
        } else {
